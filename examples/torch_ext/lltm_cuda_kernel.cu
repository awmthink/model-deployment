...
__global__ void lltm_cuda_forward_kernel(
    const scalar_t *__restrict__ gates, const scalar_t *__restrict__ old_cell,
    scalar_t *__restrict__ new_h, scalar_t *__restrict__ new_cell,
    scalar_t *__restrict__ input_gate, scalar_t *__restrict__ output_gate,
    scalar_t *__restrict__ candidate_cell, size_t state_size) {
  ...
  AT_DISPATCH_FLOATING_TYPES(
      gates.type(), "lltm_forward_cuda", ([&] {
        lltm_cuda_forward_kernel<scalar_t><<<blocks, threads>>>(
            gates.data_ptr<scalar_t>(), old_cell.data_ptr<scalar_t>(),
            new_h.data_ptr<scalar_t>(), new_cell.data_ptr<scalar_t>(),
            input_gate.data_ptr<scalar_t>(), output_gate.data_ptr<scalar_t>(),
            candidate_cell.data_ptr<scalar_t>(), state_size);
      }));
